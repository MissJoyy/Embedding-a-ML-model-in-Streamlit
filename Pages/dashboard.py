...
def app():
    ...
    if authentication_status is None:
        ...
        if st.session_state.payment_method:
            ...
            payment_method_filter = contract_filter
        ...
        def eda_dashboard():
            ...
            if st.session_state.analysis == "Univariate":
                ...
                with col2:
                    totalcharges_histogram = px.histogram(df, x="TotalCharges", title="Distribution of TotalCharges")
            ...
            with col1:
                st.markdown(
                    ...
                    <div style="background-color: lightgreen; border-radius:10px; width:80%; margin-top: 20px">
                        ...
                        <hr>
                        <h5 style="margin-left:30px">Number of Customers: {df.shape[0]}</h5>
                    </div>
                    """,
        ...
        # Select and display dashboard type
